            ...
            <section>
              <section class="vbox">
                <section class="scrollable padder-lg w-f-md" id="bjax-target" style="bottom:0px">
                  <h2 class="font-thin m-b">Les films les plus populaires <span class="musicbar animate inline m-l-sm" style="width:20px;height:20px">
                  ...
                  <div class="row">
                    <div class="col-md-7">
                      <h2 class="font-thin">Les séries télévisées les plus populaires</h2>
                      <div class="row row-sm" id="MostPopularTvShows"></div>
                    </div>
                    <div class="col-md-5">
                      <h2 class="font-thin">Les films les mieux notés </h2>
                      <div class="list-group bg-white list-group-lg no-bg auto" id="TopRatedMovies">                          
                     </div>
                    </div>
                  </div>
