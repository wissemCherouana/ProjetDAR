            ...
            <section>
              <section class="vbox">
                <section class="scrollable padder-lg w-f-md" id="bjax-target" style="bottom:0px">
                	...
                	<div class="row"> <iframe id="map" src="https://data.iledefrance.fr/explore/embed/dataset/les_salles_de_cinemas_en_ile-de-france/map/?location=8,48.70538,2.49273&basemap=jawg.streets&static=false&datasetcard=false" height="500" width="1160" frameborder="0"></iframe>
                 </div>
