    ...
    <div class="container aside-xl">
      ...
      <section class="m-b-lg">
        ...
        <form>
          ...
          <button id="userlogin" onclick="LoginCinephile();return false;" type="submit" class="btn btn-lg btn-warning lt b-white b-2x btn-block btn-rounded" ><i class="icon-arrow-right pull-right"></i><span class="m-r-n-lg">Se connecter</span></button>
          <div class="line line-dashed"></div>
          <p class="text-muted text-center"><small>Vous n'avez pas de compte ? </small></p>
          <a href="Signup.jsp" class="btn btn-lg btn-info btn-block btn-rounded">S'inscrire</a>
        </form>
