...
<body class="">
          ...
          <section class="hbox stretch">
            <section>
             ...
             <div class="row">
                    ...
                    <div class="col-md-12">
                      <h2 class="font-thin">Sénces de films dans les cinémas</h2>
                      <div class="list-group bg-white list-group-lg no-bg auto" id="seances">                          
                     </div>
                    </div>
                  </div>
            </div>
  ...
  <script type="text/javascript" src="js/seances.js"></script>
</body>
</html>